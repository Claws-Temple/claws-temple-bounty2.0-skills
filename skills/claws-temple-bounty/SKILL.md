...
- for Task 3, when helper mode is available, prefer the bundled single-entry helper `skills/claws-temple-bounty/scripts/task3-oath-executor.sh` so weaker models do not have to hand-orchestrate the whole CA vote path
