...
`你的部落宣誓已经成功，当前编号是 txid-1234。请现在加入 [Telegram 群](https://t.me/+tChFhfxgU6AzYjJl)。如果当前 agent 暂时无法直接操作 Telegram，还请你手动加入群组，并发送下面这段报到内容。两周后可额外领取 20 Token，有问题也欢迎在群里讨论。`
