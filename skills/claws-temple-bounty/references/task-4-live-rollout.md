...
- `test rollout`
  ...
  - for OpenClaw, the usable native dependency must already be locally available
...
- OpenClaw native dependency missing
  ...
  - user promise: explain the exact missing native dependency or account prerequisite plainly
